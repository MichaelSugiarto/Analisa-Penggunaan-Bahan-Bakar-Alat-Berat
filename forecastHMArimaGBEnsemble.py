...
def prepare_data():
    ...
    df_all = pd.concat([df_2023, df_2024, df_des_2025, df_jan_nov_25], ignore_index=True)
...
def run_forecast_pipeline():
    ...
    for unit in list_unit_raw:
        ...
        try:
            ...
            # Simpan metrik — PERBAIKAN: gunakan hanya 'EQUIP NAME' sebagai key unik
            metrics_list.append({
                'EQUIP NAME':             unit,
            ...
            # Simpan hasil per baris — kolom terpilih sudah ada di sini langsung
    ...
    # PERBAIKAN: semua kolom sudah ada di df_combined, tidak perlu merge lagi
    # Sheet terpilih langsung dari df_combined
    ...
    # MAPE global sebagai referensi summary
    ...
    # Sheet Komparasi: df_combined + metrik dari df_metrics (merge by EQUIP NAME saja)
    ...
    # Tambah bobot dari df_metrics ke komparasi
